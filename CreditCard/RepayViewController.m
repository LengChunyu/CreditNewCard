...
@end
struct utsname repaySystemInfo;
...
- (void)viewDidLoad {
    ...
    uname(&repaySystemInfo);
    NSString *mode= [NSString stringWithCString:repaySystemInfo.machine encoding:NSASCIIStringEncoding];
...
-(void)getData{
    ...
    NSString  *markString =[[NSUserDefaults standardUserDefaults]objectForKey:@"repayMarkSourceArray"];
...
-(void)creatPay{
    ...
    backView.backgroundColor =[UIColor colorWithRed:0.99 green:0.50 blue:0.47 alpha:1.00];
    ...
    self.moneyTextLabel.textColor =[UIColor colorWithRed:1.00 green:0.73 blue:0.70 alpha:1.00];
...
-(void)remenberButtonClick:(UIButton *)button{
    ...
    if (self.sourceMuArray.count>=10) {
        ...
        [[NSUserDefaults standardUserDefaults]setObject:markString forKey:@"repayMarkSourceArray"];
